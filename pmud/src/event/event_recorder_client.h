...
namespace primordia::mud::event {
  ...
  public:
    ...
    void record_event_user_create(const string& username, const string& password) {
      caf::anon_send(actor_cast<actor>(m_event_actor), EventUserCreate(), username, password);
    }
