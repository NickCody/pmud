...
struct Vertex {
  ...
  public:
    Vertex(int index, std::optional<D> data = nullopt) : _index(index), data(data) {}
    Vertex() = delete;
    ...
    iterator begin() { return _adj.begin(); }
    iterator end() { return _adj.end(); }
    const_iterator begin() const { return _adj.begin(); }
    const_iterator end() const { return _adj.end(); }
    const_iterator cbegin() const { return _adj.cbegin(); }
    const_iterator cend() const { return _adj.cend(); }
